...
#ifdef OLD_MAP_SINGLE_CLASS
	using Set = LinkedHashMap;
#else
...
#ifdef OLD_MAP_SINGLE_CLASS
		kConstSetCid = kLinkedHashMapCid,
#else
...
#ifdef PRE_UNTAGGED_OBJECT
namespace dart {
	using UntaggedObject = ObjectLayout;
};
#endif
