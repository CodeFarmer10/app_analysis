...
class DeviceFactory:
    ...
    def get_screenshot(self, device_id: str | None = None, screenshot_dir: str | None = None, timeout: int = 10):
        """Get screenshot from device."""
        return self.module.get_screenshot(device_id, screenshot_dir, timeout)
    ...
    def launch_app_by_package(
        self, package: str, device_id: str | None = None, delay: float | None = None
    ) -> bool:
        """Launch an app by package name."""
        return self.module.launch_app_by_package(package, device_id, delay)
